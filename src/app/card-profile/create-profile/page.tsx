...
const CreateProfilePagee = () => {
  ...
  //   const handleAddFeeClick = () => {setShowAddFeeModal(true); };
  return (
    <>
      <AppWrapper>
              ...
              <tbody>
                ...
                >
                  {[1, 2, 3, 4, 5, 6, 7].map((_, index) => (
                    <td
                      key={index}
                      className="text-[#475467] text-xs font-normal border-r border-r-[#EAECF0] w-48 px-6"
                    >
                      {/* {item.name} */}
                    </td>
                  ))}
        ...
        <button
          ...
          //   onClick={() => router.push("/card-profile/create-profile")}
          className="bg-[#014DAF] w-80 rounded h-11 mt-9 mb-20"
        >
